---
name: cursor-review-security
description: >-
  Review code changes with the Security Review subagent. Computes diffs,
  launches a security-review subagent, and summarizes findings by severity.
  Use when the user asks to run /review-security or wants a security-focused
  code review.
metadata:
  version: "0.1.0"
---
