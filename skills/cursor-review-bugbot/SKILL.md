---
name: cursor-review-bugbot
description: >-
  Review code changes with the Bugbot subagent. Computes diffs, launches a
  bugbot subagent, and summarizes findings by severity. Use when the user asks
  to run /review-bugbot or wants a bug-focused code review.
metadata:
  version: "0.1.0"
---
# Review Bugbot
